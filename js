function validatePASS ()
{
	...
	var psw2= document.getElementById("re-password").value;
		if(psw1==psw2) //returns ture if passwords entered by user matches
		{
			return true;
		}
		else
...
{	
	...
	var l= n.length;
		if(l<2) //since firstname cannot be of one alphabet
		{
...
document.write("example exampe asdaskndasknas asjvbjaf");
